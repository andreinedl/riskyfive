...
module singlecycle_control_unit(
    ...
    output logic [2 - 1:0] alu_a_src_o, // 2'b00 - rs1, 2'b01 - PC, 2'b10 - 0
    output logic           alu_b_src_o, // 1'b0 - rs2, 1'b1 - imm
    output logic [2 - 1:0] ALUOp_o, // 2'b00 - ADD, 2'b01 - SUB, 2'b10 - OP, 2'b11 - OP-IMM
    output logic           reg_write_en_o,
    output logic [2 - 1:0] rd_result_src_o, // 2'b00 - ALU, 2'b01 - Memory, 2'b10 - PC + 4     
    output logic           jump_o,
